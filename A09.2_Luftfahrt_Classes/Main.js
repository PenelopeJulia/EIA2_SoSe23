...
(function (A09LuftfahrtClasses) {
    ...
    function drawBackground() {
        // Create Background
        let gradient = A09LuftfahrtClasses.crc2.createLinearGradient(0, 0, 0, A09LuftfahrtClasses.crc2.canvas.height);
        gradient.addColorStop(0, "lightblue");
        gradient.addColorStop(horizon, "lightgrey");
        gradient.addColorStop(1, "#C7F9CD");
        // Fill Canvas with Background
        A09LuftfahrtClasses.crc2.fillStyle = gradient;
        A09LuftfahrtClasses.crc2.fillRect(0, 0, A09LuftfahrtClasses.crc2.canvas.width, A09LuftfahrtClasses.crc2.canvas.height);
        // Mountains Positioning in Canvas
        let startMountain = A09LuftfahrtClasses.crc2.canvas.height * horizon;
        ...
        background = A09LuftfahrtClasses.crc2.getImageData(0, 0, A09LuftfahrtClasses.crc2.canvas.width, A09LuftfahrtClasses.crc2.canvas.height);
    }
    // Draw Sun 
    function drawSun(_position) {
        let sun = A09LuftfahrtClasses.canvas.getContext("2d");
        // Radius from Circles
        let r1 = 25;
        let r2 = 150;
        // Gradient: to create feathering effect
        let gradient = A09LuftfahrtClasses.crc2.createRadialGradient(0, 0, r1, 0, 0, r2);
    ...
    function drawCloud(_position, _size) {
        let cloud = A09LuftfahrtClasses.canvas.getContext("2d");
        let nParicles = 20;
        let radiusParticle = 50;
        let particle = new Path2D();
        let gradient = A09LuftfahrtClasses.crc2.createRadialGradient(0, 0, 0, 0, 0, radiusParticle);
    ...
    function drawMountain(_position, _min, _max, _colorLow, _colorHigh) {
        let mountainLine = A09LuftfahrtClasses.canvas.getContext("2d");
    ...
    function drawZone(_position) {
        let zone = A09LuftfahrtClasses.canvas.getContext("2d");
        zone.beginPath();
    ...
    function drawTree(_position, _max) {
        let tree = A09LuftfahrtClasses.canvas.getContext("2d");
        // Tree Trunk
        tree.beginPath();
    ...
    function drawHouse(_position) {
        let house = A09LuftfahrtClasses.canvas.getContext("2d");
